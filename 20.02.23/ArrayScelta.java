...
public class ArrayScelta {
    ...
    //Inizio ciclo col do while (Verrà eseguito ALMENO una volta)
        ...
        do{
            ...
            System.out.println("NOTA BENE! SE SI SCEGLIE DI INSERIRE IL VALORE INSERITO SARA' INSERITO NELL'ULTIMA POSIZIONE DELL'ARRAY\n");
            selezione=myObj.nextInt();

            Switcherino();
        }while(uscita!=true); // la variabile la controlla se vera sempre, ma solo nel caso del case: 0 viene resa vera e quindi rompe il loop
    }
    ...
    public static void Switcherino(){
        switch(selezione){
            ...
            uscita=true;
            break;
            //Se non inserisce nessuno dei 3 numeri da inserimento errato e ripete la selezione iniziale
            default:
